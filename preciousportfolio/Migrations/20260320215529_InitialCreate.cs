        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Purity = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Quantity = table.Column<int>(type: "INTEGER", nullable: false),
                    AcquiredDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    AcquiredPrice = table.Column<decimal>(type: "TEXT", nullable: true),
                    Dealer = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
